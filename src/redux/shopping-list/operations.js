...
export const addToShoppingList = createAsyncThunk(
	...
	async (product, thunkAPI) => {
	  try {
		 const response = await axios.post('/ingredients/shopping-list/add-ingredient', product);
		 return response.data;
	  } catch (error) {
		 return thunkAPI.rejectWithValue(error.message);
	  }
 ...
 export const removeFromShoppingList = createAsyncThunk(
	...
	async (product, thunkAPI) => {
	  try {
		 const response = await axios.post('ingredients/shopping-list/remove-ingredient', product);
		 return response.data;
	  } catch (error) {
		 return thunkAPI.rejectWithValue(error.message);
	  }
